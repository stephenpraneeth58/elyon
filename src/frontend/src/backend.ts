...
export class Backend implements backendInterface {
    ...
    async createGoal(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createTask(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getCompletedTaskCountToday(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompletedTaskCountToday(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCompletedTaskDatesForCurrentUser(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompletedTaskDatesForCurrentUser();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGoalsForCurrentUser(): Promise<Array<Goal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGoalsForCurrentUser();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksForCurrentUser(): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasksForCurrentUser();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasksForGoal(arg0: bigint): Promise<Array<Task>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasksForGoal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uncompleteTask(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uncompleteTask(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTask(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
